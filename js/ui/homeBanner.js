...
export async function homeBanner() {
	...
	try {
		...
		heroBannerContainer.innerHTML = `<img src="https://res.cloudinary.com/kimobv/image/upload/c_fill,g_auto,h_250,w_970,w_0.5,y_0.18/v1670793068/hero.jpg" class="flex-grow-1" alt="...">`;
	}
}
