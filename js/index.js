					...
					featuredContainer.innerHTML += `
						<div class="col">
							<div class="card border-dark mb-3" style="width: 18rem;">
								<a href="products-details.html?id=${products[i].id}" class="text-decoration-none" style="color: black" aria-label="${products[i].title}">
									...
									<div class="card-body text-center">
										...
										<h4 class="card-text">kr. ${products[i].price}</h4>
									</div>
								</a>
							</div>
						</div>`;
